...
```bash
python3 ~/.codex/skills/.system/skill-installer/scripts/install-skill-from-github.py --repo TODOTODoTOdoTodotodo/wassup_hudson --path skills/jenkins-build-status
```
...
설치 후에는 Codex를 다시 시작해야 새 스킬이 반영됩니다.
